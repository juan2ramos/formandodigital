<?php get_header(); ?>
    ...
    <section class="Directed container">
        ...
        <div class="row between center">
            <article class="col-5 medium-8 small-16">
                <figure><img src="<?php bloginfo('template_url') ?>/assets/img/1.png" alt=""></figure>
                <h3>Desarolladores</h3>
                <p>Cualquier tipo de persona que este iniciando un negocio o tenga el deseo de ser un emprendedor
                    Cualquier tipo de persona que este iniciando </p>
            </article>
            <article class="col-5 medium-8 small-16">
                <figure><img src="<?php bloginfo('template_url') ?>/assets/img/1.png" alt=""></figure>
                <h3>Desarolladores</h3>
                <p>Cualquier tipo de persona que este iniciando un negocio o tenga el deseo de ser un emprendedor </p>
            </article>
            <article class="col-5 medium-8 small-16">
                <figure><img src="<?php bloginfo('template_url') ?>/assets/img/1.png" alt=""></figure>
                <h3>Desarolladores</h3>
        ...
        <div class="container">
            ...
            <div class="row between ">
                <article class="col-4 medium-5 small-16">
                    <figure><img src="<?php bloginfo('template_url') ?>/assets/img/m.png" alt=""></figure>
                    <h3>Marketing digital</h3>
                    <p>Cualquier tipo de persona que este iniciando un negocio o tenga el deseo de ser un emprendedor
                        Cualquier tipo de persona </p>
                </article>
                <article class="col-4 medium-5 small-16">
                    <figure><img src="<?php bloginfo('template_url') ?>/assets/img/h.png" alt=""></figure>
                    <h3>Hosting y dominio</h3>
                    <p>Cualquier tipo de persona que este iniciando un negocio o tenga el deseo de ser un emprendedor
                        Cualquier tipo de persona </p>
                </article>
                <article class="col-4 medium-5 small-16">
                    <figure><img src="<?php bloginfo('template_url') ?>/assets/img/md.png" alt=""></figure>
                    <h3>Mejores desiciones</h3>
                    <p>Cualquier tipo de persona que este iniciando un negocio o tenga el deseo de ser un emprendedor
                        Cualquier tipo de persona </p>
                </article>
                <article class="col-4 medium-5 small-16">
                    <figure><img src="<?php bloginfo('template_url') ?>/assets/img/e.png" alt=""></figure>
                    <h3>Estrategia</h3>
                    <p>Cualquier tipo de persona que este iniciando un negocio o tenga el deseo de ser un emprendedor
                        Cualquier tipo de persona </p>
                </article>
    ...
    <section class="Why row middle container">
        ...
        <article class=" col-8 medium-8 small-16 ">
            <h2>¿Por qué tomar este entrenamiento?</h2>
            <h3>Experiencia </h3>
            <p>Tenemos ás de 5 años de experiencia en la generadción de ingresos por internet </p>
            <h3>Guias</h3>
            <p>Entregamos guias practicas y sencillas </p>
    ...
    <section class="Register">
        <div class="container">
            ...
            <h2>Regístrate hoy a nuestro curso</h2>
            ...
            <div class="row center">
                <ul class="col-8 small-16   ">
                    ...
                    <li class="row middle">
                        <img class="small-3" src="<?php bloginfo('template_url') ?>/assets/img/ads.png" alt="">
                        <p class="small-13">Información actulizada de google adsense</p>
                    </li>
                    <li class="row middle">
                        <img src="<?php bloginfo('template_url') ?>/assets/img/pre.png" alt="">
                ...
                <ul class="col-8 small-16">
                    ...
                    <li class="row middle">
                        <img class="small-3" src="<?php bloginfo('template_url') ?>/assets/img/pre.png" alt="">
                        <p class="small-13">Seminario presencial</p>
                    </li>
                </ul>
            </div>
